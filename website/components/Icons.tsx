...
export function WhatsAppIcon({ className }: IconProps) {
  // Brand glyph — uses fill, not stroke.
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export function TruckIcon({ className }: IconProps) {
  return (
    <svg {...base(className)}>
      ...
      <path d="M14 9h5l3 3v5a1 1 0 0 1-1 1h-1" />
...
export function PaintRollerIcon({ className }: IconProps) {
  return (
    <svg {...base(className)}>
      ...
      <path d="M16 6h3a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-7a2 2 0 0 0-2 2v1" />
...
export function PaintBucketIcon({ className }: IconProps) {
  return (
    <svg {...base(className)}>
      <path d="M19 11 9 1 2 8a2 2 0 0 0 0 3l6 6a2 2 0 0 0 3 0z" />
      <path d="m5 2 5 5" />
      <path d="M2 13h15" />
